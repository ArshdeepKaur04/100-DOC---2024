...
Your task is to construct the binary tree from the given level-order traversal and then perform a postorder
traversal on it. The postorder traversal should be printed as a list of node values.
*/
