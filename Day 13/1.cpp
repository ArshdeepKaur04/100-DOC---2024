/*
Question:
Determine if a string can be segmented into a space-separated sequence of dictionary words. Give the output "YES" 
if the string can be segmented, otherwise "NO". 
*/
